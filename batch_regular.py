                ...
                for algorithm in algorithmRange:
                    for wirelessTechnology in wirelessTechnologyRange:
                        ...
                        if (numDepots == 1 and (algorithm == 0 or algorithm == 1)) or \
                            ...
                            fullCommand = f"{baseCommand} -exp_name {expName} -num_sensors {numSensors} -num_depots {numDepots} -sensor_radius {sensorRadius} -energy_budget {energyBudget} -wireless_technology {wirelessTechnology} -algorithm {algorithm} -scenario 0"
