...
//    double dx = pow((double) (c1.x - c2.x), 2);
//    double dy = pow((double) (c1.y - c2.y), 2);
//    double dz = pow((double) (c1.z - c2.z), 2);
//
//    return floor(sqrt(dx + dy + dz) + 0.5);
//}
...
int TSP::getMinIndex(const double key[], const bool mst[]) {
